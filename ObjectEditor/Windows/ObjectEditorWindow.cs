...
public class ObjectEditorWindow : EditorWindow
{
    ...
    [MenuItem("Window/ObjectEditor/EditorWindow")]

    static void Init()
    {
        // Get existing open window or if none, make a new one:
        ObjectEditorWindow window = (ObjectEditorWindow)EditorWindow.GetWindow(typeof(ObjectEditorWindow));
        window.Show();
        window.title = "ObjectEditor";
    ...
    void OnGUI()
    {
        ...
        ObjEditStruct.obj = (GameObject)EditorGUILayout.ObjectField("GameObject:", ObjEditStruct.obj, typeof(GameObject), true);
